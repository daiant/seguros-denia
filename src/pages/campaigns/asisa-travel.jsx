...
export default function AsisaTravel() {
  return (
    <div className="wrap">
      ...
      <p>
        En ASISA Viajes, queremos asegurarnos de que estés protegido en cada
        momento, sin importar a dónde vayas.{" "}
      </p>
      <p>
        Nuestros seguros de viaje están diseñados para adaptarse a tus planes y
        brindarte tranquilidad:
      </p>
      <p>
        <strong>ASISA Travel And You</strong>
      </p>
      <p>Protección completa ante cualquier incidente durante tu estancia.</p>
      <p>
        <b>ASISA Travel And You Basic</b>
      </p>
      <p>La cobertura esencial para disfrutar de tu viaje sin contratiempos.</p>
      <p>
        <b>ASISA Travel And You Cruise</b>
      </p>
